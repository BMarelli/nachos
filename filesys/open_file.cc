...
///
/// * `_sector` is the location on disk of the file header for this file.
/// * `_hdr` is the file header for this file.
...
void OpenFile::Seek(unsigned position) { seekPosition = position; }
