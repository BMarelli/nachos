...
static const unsigned NUM_DIRECT = (SECTOR_SIZE - 3 * sizeof(unsigned)) / sizeof(unsigned);
static const unsigned NUM_INDIRECT = SECTOR_SIZE / sizeof(unsigned);

const unsigned MAX_FILE_SIZE = NUM_DIRECT * SECTOR_SIZE + NUM_INDIRECT * SECTOR_SIZE;
