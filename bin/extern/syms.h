...
typedef struct {
    ...
    int cbLine;        /* number of bytes for line number entries */
    int cbLineOffset;  /* offset to start of line number entries*/
    int idnMax;        /* max index into dense number table */
    int cbDnOffset;    /* offset to start dense number table */
    int ipdMax;        /* number of procedures */
    int cbPdOffset;    /* offset to procedure descriptor table */
    int isymMax;       /* number of local symbols */
    int cbSymOffset;   /* offset to start of local symbols*/
    int ioptMax;       /* max index into optimization symbol entries */
    int cbOptOffset;   /* offset to optimization symbol entries */
    int iauxMax;       /* number of auxillary symbol entries */
    int cbAuxOffset;   /* offset to start of auxillary symbol entries*/
    int issMax;        /* max index into local strings */
    int cbSsOffset;    /* offset to start of local strings */
    int issExtMax;     /* max index into external strings */
    int cbSsExtOffset; /* offset to start of external strings */
    int ifdMax;        /* number of file descriptor entries */
    int cbFdOffset;    /* offset to file descriptor table */
    int crfd;          /* number of relative file descriptor entries */
    int cbRfdOffset;   /* offset to relative file descriptor table */
    int iextMax;       /* max index into external symbols */
    int cbExtOffset;   /* offset to start of external symbol entries*/
 ...
 */
typedef struct fdr {
    unsigned adr;            /* memory address of beginning of file */
    int rss;                 /* file name (of source, if known) */
    int issBase;             /* file's string space */
    int cbSs;                /* number of bytes in the ss */
    ...
    int cbLineOffset;        /* byte offset from header for this file ln's */
    int cbLine;              /* size of lines for this file */
} FDR, *pFDR;
...
typedef struct pdr {
    unsigned adr;     /* memory address of start of procedure */
    ...
    int cbLineOffset; /* byte offset for this procedure from the fd base */
} PDR, *pPDR;
